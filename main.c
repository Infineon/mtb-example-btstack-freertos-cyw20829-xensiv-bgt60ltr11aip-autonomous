 ...
 *              BGT60LTR11 sensing service application.
 *
...
/* This function initializes the required BLE ESS & BGT60LTR11 task */
...
int main(void)
{
    ...
    printf("\x1b[2J\x1b[;H");
    printf("****** XENSIV TM BGT60LTR11AIP Sensing Service ******\r\n");
    printf("***************************************************\n");
                           ...
                           wiced_bt_management_evt_data_t *p_event_data)
{
    ...
    {
        printf("\nThis application implements a custom XENSIV TM BGT60LTR11AIP Sensing\n" \
                "Service and sends XENSIV TM BGT60LTR11AIP sensor data over BLE\n");
